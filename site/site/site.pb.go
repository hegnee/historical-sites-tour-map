...
const file_site_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"site.proto\x12\x04site\"\x1d\n" +
	"\aRequest\x12\x12\n" +
	"\x04ping\x18\x01 \x01(\tR\x04ping\"\x1e\n" +
	"\bResponse\x12\x12\n" +
	"\x04pong\x18\x01 \x01(\tR\x04pong2-\n" +
	"\x04Site\x12%\n" +
	"\x04Ping\x12\r.site.Request\x1a\x0e.site.ResponseB\bZ\x06./siteb\x06proto3"
...
var file_site_proto_goTypes = []any{
	(*Request)(nil),  // 0: site.Request
	(*Response)(nil), // 1: site.Response
}
var file_site_proto_depIdxs = []int32{
	0, // 0: site.Site.Ping:input_type -> site.Request
	1, // 1: site.Site.Ping:output_type -> site.Response
